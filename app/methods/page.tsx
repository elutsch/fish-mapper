...
const dataSources = [
  ...
  {
    title: "Deterministic fishing note",
    body:
      "Craft verdicts and notes are generated by deterministic rules from the structured forecast, pressure, fetch, and launch-profile inputs. The production scoring path does not call an LLM."
  },
  {
        ...
        <div className="method-split">
          ...
          <article>
            ...
            <p>
              ...
              refreshes through the site's revalidation and cron workflow.
            </p>
          </article>
        </div>
      </section>
